...
queueName = 'SCQueue'
key = 'sc.validation'
notification_consumer_config = { 'host': 'fishymq.xlab.si', 'port': 45672, 'exchange' : 'sc-results', 'login':'tubs', 'password':'sbut'}

if __name__ == '__main__':
    try:
       init_rabbit = SCsubscriber(queueName, key, notification_consumer_config)
       init_rabbit.setup()
    except KeyboardInterrupt:
        print('Interrupted')
        try:
